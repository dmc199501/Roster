...
#define kMainPageDistance   (kScreenWidth*0.2)   //打开左侧窗时，中视图(右视图)露出的宽度
...
#define vCouldChangeDeckStateDistance  (kScreenWidth - kMainPageDistance) / 2.0 - 80 //滑动距离大于此数时，状态改变（关--》开，或者开--》关）
