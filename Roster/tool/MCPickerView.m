...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        backgroundView = [[UIView alloc]initWithFrame:CGRectMake(0, self.frame.size.height - 300, self.frame.size.width, 300)];
        ...
        [_cancelButton setTitleColor:[UIColor colorWithRed:50 / 255.0 green:151 / 255.0 blue:251 / 255.0 alpha:1]  forState:UIControlStateNormal];
        ...
        [_finishButton setTitleColor:[UIColor colorWithRed:50 / 255.0 green:151 / 255.0 blue:251 / 255.0 alpha:1] forState:UIControlStateNormal];
        [_finishButton setTitle:@"完成" forState:UIControlStateNormal];
        [_finishButton addTarget:self action:@selector(finish:) forControlEvents:UIControlEventTouchUpInside];
        
        self.choosePickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 50, self.frame.size.width, 250)];
       ...
       // [backgroundView addSubview:lineImageView];
        [lineImageView setBackgroundColor:[UIColor colorWithRed:200 / 255.0 green:200 / 255.0 blue:200 / 255.0 alpha:1]];
...
- (void)showInView:(UIView *)view animation:(BOOL )animation;
{
    ...
    if (animation)
    {
        [backgroundView setFrame:CGRectMake(0, self.frame.size.height, self.frame.size.width, 300)];
        [UIView animateWithDuration:0.3 animations:^{
            
            [backgroundView setFrame:CGRectMake(0, self.frame.size.height - 300, self.frame.size.width, 300)];
        }];
    }
    else
    {
